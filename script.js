...
const SUPABASE_URL = 'https://oknregnsmpitpfetqfwp.supabase.co/rest/v1/';
...
// ==========================================
const targetWeddingDate = new Date("september 23, 2026 08:00:00").getTime();
...
async function loadSavedWishes() {
    ...
    try {
        ...
        setWishStatus(`${wishes.length} ucapan tersimpan untuk kita semua.`);
    } catch (error) {
        renderWishes(getLocalWishes());
...
wishForm.addEventListener('submit', async function(e) {
    ...
    try {
        if (isCloudStorageConfigured()) {
            ...
            setWishStatus('Ucapan berhasil dikirim dan akan terlihat oleh semua pengunjung.');
        } else {
